...
public class CameraController : MonoBehaviour
{
    ...
    public float minZoom = 0f; // Minimum zoom (base Y position)
    public float maxZoom = 50f; // Maximum zoom relative to base Y position
    public float minRotationX = 0f; // Minimum X rotation
    public float maxRotationX = 90f; // Maximum X rotation
