...
public class TowerStatsUI : MonoBehaviour
{
    ...
    /// <summary>
    /// Updates the UI with the tower's stats.
    /// </summary>
    /// 
    ...
    void Update ()
    {
        ...
        {
            if (tower.isClicked && (currentTower != tower || currentTower == null))
            {
                currentTower = tower;
   ...
   void LateUpdate()
    {
        if (canvas != null && currentTower != null && Camera.main != null)
        {
            ...
            // This gives you a vector perpendicular to towerToCamera (to the right).
    ...
    void SetUpReferences(Canvas canvas)
    {
    ...
    public void DisplayTowerStats(Tower tower)
    {
        ...
        if (tower is MageTower mageTower)
        {
            ...
            extraStatText.text = $"Slow Factor: {mageTower.slowFactor * 100}%";
        }
    ...
    /// <summary>
    /// Hides the UI when no tower is selected.
    /// </summary>
